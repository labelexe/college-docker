...
class GBM_Admin {
     ...
     * Добавление суб меню настрое
	 */
	public function gbm_register_sub_menu() {

		add_submenu_page(
			'options-general.php',
			esc_html__( 'Управление блоками Gutenberg', 'gutenberg-block-manager' ),
			esc_html__( 'Управление блоками Gutenberg', 'gutenberg-block-manager' ),
	...
	public function gbm_submenu_page_callback() {		
		...
		<div class="gbm-page-wrap">
			<div class="gbm-page-wrap--header">
				<h2><?php _e( 'Управление блоками Gutenberg', 'gutenberg-block-manager' ); ?></h2>
				<p><?php printf( __( 'Сейчас активно %s блоков', 'gutenberg-block-manager' ), '<span class="cnkt-block-totals block-total">--</span>'); ?>
