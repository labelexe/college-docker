...
<div class="container">
    ...
    <ul class="nav nav-tabs">
        <li><a href="<?php echo admin_url('admin.php'); ?>?page=wp_moodle_handler">Home</a></li>
        <li class="active"><a  href="<?php echo admin_url('admin.php'); ?>?page=moodle_courses_handle">Moodle Courses</a></li>
    </ul>
    <br>

    <div class="tab-content">
        <div id="test_api" class="tab-pane fade in active">

          <ul>
              <?php if(!empty($contents_arr)){
                  foreach($contents_arr as $content){?>
                      <li><?php echo $content->fullname?></li>
                  <?php }
              }else{
              echo '<p class="btn btn-danger">API Error</p>';
              }
              ?>
          </ul>
