...
class Home_GoToAction_Widget extends SiteOrigin_Widget
{
    ...
    function __construct()
    {
        ...
        parent::__construct(
            ...
            __('Текущая – Блок поступай к нам', 'main-header-hero-widget-text-domain'),

            // The $widget_options array, which is passed through to WP_Widget.
            // It has a couple of extras like the optional help URL, which should link to your sites help or support page.
            array(
                'description' => __('Отображаем блок инфомрацией о поступлении', 'hello-world-widget-text-domain'),
...
siteorigin_widget_register('gotoaction-widget', __FILE__, 'Home_GoToAction_Widget');
